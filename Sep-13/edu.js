...
function getDetails(resume){
    for(var i=0;i<resume.Educational_Qualification.length;i++){
        console.log(i+1,resume.Educational_Qualification[i].place)
     }
}
getDetails(my_resume)